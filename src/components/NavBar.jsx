...
const navigationtwo = [
    ...
    { name: 'About', href: '#header', current: false, id:'headerid',scrolldown:0 },
    { name: 'Contact', href: '#advantage', current: false,id:'advantageid' },
    { name: 'For Brand', href: '#hotoffers', current: false, id:'hotofferid' },
    { name: 'For Creators', href: '#locations', current: false, id:'locationid' },
                    ...
                    {navigationtwo.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? ' text-white' : 'text-black  text-lg font-gotham font-bold',
